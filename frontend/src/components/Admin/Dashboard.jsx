...
function Dashboard() {
  ...
  useEffect(() => {
    axios.get(`${process.env.REACT_APP_SERVER}/api/users/users`)
      .then(response => {
    ...
    axios.get(`${process.env.REACT_APP_SERVER}/api/booking/reservations`)
      .then(response => {
    ...
    axios.get(`${process.env.REACT_APP_SERVER}/api/table/`)
      .then(response => {
